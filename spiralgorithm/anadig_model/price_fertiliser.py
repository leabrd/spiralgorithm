...
def FertiliserPrices (csv_files, ddir):
    '''
    ...
    plt.savefig('fertiliser_price.pdf')
...
def DigestatePrice (df_NPK, data_dict):
    ...
    plt.savefig('digestate_price.pdf')
    ...
    plt.savefig('digestate_compo.pdf')
