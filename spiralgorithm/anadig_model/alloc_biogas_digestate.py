...
#mdir1 = '/home/leabraud/Dropbox/spiralgorithm/lca_calc'
#mdir2 = '/home/leabraud/Dropbox/spiralgorithm/anadig_model'

#for mdir in [mdir1, mdir2]:
#    if mdir not in sys.path:
#        sys.path.insert(0,mdir)

def AllocationBiogasDigestate (allocation_type, data_dict, ddir, resdir):
    ...
    if allocation_type == 'economic': 
        ...
        df_fertilisers = FertiliserPrices (csv_files, ddir, resdir)
        df_NPK = NPKPrices (df_fertilisers, resdir)
        df_digestate = DigestatePrice (df_NPK, data_dict, resdir)
        
        # calculate the economic value of the daily produced biogas
        csv_file = 'data_natural_gas.csv'
        df_natural_gas = NaturalGasPrice (csv_file, ddir, resdir)
        df_biogas = BiogasPrice (df_natural_gas, data_dict, resdir)
        ...
        plt.savefig(str(resdir + '/allocation_factors_biogas.pdf'))
