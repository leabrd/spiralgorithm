...
def CreateForegroundDatabase (wdir, project_name, comparison_dict_per_FU, ei_datasets_file_dir, database_name):
    ...
    from bw2io import BW2Package, lci_matrices_to_excel
    ...
    for scenario in comparison_dict_per_FU.keys():
        ...
        ## EXPORT THE DATABASE IN THE NATIVE BRIGHTWAY 2 FORMAT
        ...
        ## EXPORT THE DATABASE IN AN EXCEL FILE
        lci_matrices_to_excel(database_name = my_db_name, include_descendants = True)
