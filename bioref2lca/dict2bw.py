...
def CreateForegroundDatabase (wdir, project_name, comparison_dict, ei_datasets_file_dir, database_name, PerSubsystem = False):
    '''
    Function that converts the date dictionaries obtained from the python models 
    (e.g. biorefinery model) into BW2Package files. 
    ...
    comparison_dict_per_FU : dict
        Nested ictionary of data built as follows: subsystem > tech period > act.
